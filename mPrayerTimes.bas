Attribute VB_Name = "mPrayerTimes"
...
'Download PrayerTimes.dll source and binaries from our
'website www.islamware.com
'==========================================================
Option Explicit
...
Public Declare Sub GetRatior Lib "PrayerTimes.dll" (ByVal yg As Long, ByVal mg As Long, ByVal dg As Long, ByRef Param As Double, ByRef IshRt As Double, ByRef FajrRt As Double)

'double WINAPI atanxy(double x,double y);
Public Declare Function atanxy Lib "PrayerTimes.dll" (ByVal X As Double, ByVal y As Double) As Double

'void WINAPI EclipToEquator(double lmdr,double betar,double &alph, double &dltr);
Public Declare Sub EclipToEquator Lib "PrayerTimes.dll" (ByVal lmdr As Double, ByVal betar As Double, ByRef alph As Double, ByRef dltr As Double)

'double WINAPI RoutinR2(double M,double e)
'    Calculate the value of E
'    p.91, Peter Duffett-Smith book
Public Declare Function RoutinR2 Lib "PrayerTimes.dll" (ByVal M As Double, ByVal e As Double) As Double
...
'/****************************************************************************/
Public Declare Function GCalendarToJD Lib "PrayerTimes.dll" (ByVal yg As Long, ByVal mg As Long, ByVal dg As Double) As Double
...
Public Declare Function SunParamr Lib "PrayerTimes.dll" (ByVal yg As Long, ByVal mg As Long, _
...
'int WINAPI PrayerTimes(int yg,int mg,int dg, double param[], double lst[]);
'/*
...
'/*****************************************************************************/
Public Declare Function PrayerTimes Lib "PrayerTimes.dll" (ByVal yg As Long, _
...
'/****************************************************************************/
Public Declare Function BH2GA Lib "PrayerTimes.dll" (yh As Long, mh As Long, yg As Long, mg As Long, dg As Long, DayWeek As Long) As Long
...
'/*       and returns flag found:1 not found:0                               */
'/****************************************************************************/
Public Declare Function G2HA Lib "PrayerTimes.dll" (yg As Long, mg As Long, dg As Long, yh As Long, mh As Long, dh As Long, DayWeek As Long) As Long
...
'/****************************************************************************/
Public Declare Function H2GA Lib "PrayerTimes.dll" (yh As Long, mh As Long, dh As Long, yg As Long, mg As Long, dg As Long, DayWeek As Long) As Long
...
'/****************************************************************************/
Public Declare Function JDToGCalendar Lib "PrayerTimes.dll" (ByVal JD As Double, _
...
'/****************************************************************************/
Public Declare Function GLeapYear Lib "PrayerTimes.dll" (ByVal Year As Long) As Long
...
'/****************************************************************************/
Public Declare Sub GDateAjust Lib "PrayerTimes.dll" (ByRef yg As Long, ByRef mg As Long, ByRef dg As Long)
...
'  Dy=6 Saturday
'*/
Public Declare Function DayWeek Lib "PrayerTimes.dll" (ByVal JulianD As Long) As Long
...
'/****************************************************************************/
Public Declare Function DayinYear Lib "PrayerTimes.dll" (ByVal yh As Long, ByVal mh As Long, ByVal dh As Long) As Long
...
'/* Output:  Year Length                                                     */
'/****************************************************************************/
Public Declare Function HYearLength Lib "PrayerTimes.dll" (ByVal yh As Long) As Long
...
'/****************************************************************************/
Public Declare Sub JDToHCalendar Lib "PrayerTimes.dll" (ByVal JD As Double, _
...
'/* Output : Hijrah date: year:yh, month:mh, day:dh                          */
'/****************************************************************************/
Public Declare Sub JDToHACalendar Lib "PrayerTimes.dll" (ByVal JD As Double, _
        ByRef yh As Long, ByRef mh As Long, ByRef dh As Long)
...
'/****************************************************************************/
Public Declare Function HCalendarToJD Lib "PrayerTimes.dll" (ByVal yh As Long, _
...
'/* Output:  The Exact Julian Day: JD                                        */
'/****************************************************************************/
Public Declare Function HCalendarToJDA Lib "PrayerTimes.dll" (ByVal yh As Long, _
    ByVal mh As Long, ByVal dh As Long) As Double

'int WINAPI IsValid(int yh, int mh, int dh)
'/* Purpose: returns 0 for incorrect Hijri date and 1 for correct date      */
Public Declare Function IsValid Lib "PrayerTimes.dll" (ByVal yh As Long, _
...
'/* Output:  Month Length                                                    */
'/****************************************************************************/
Public Declare Function HMonthLength Lib "PrayerTimes.dll" (ByVal yh As Long, ByVal mh As Long) As Long
...
Public Function PrayTimes(ByVal yg As Long, _
    ...
    PrayTimes = PrayerTimes(yg, mg, dg, Param(0), lst(0))
